...
public class PDFgenerator {
    ...
    private void Creardocumento() throws DocumentException, FileNotFoundException {
        ...
        fos = new FileOutputStream( "D:\\\\Usuarios\\\\Franz\\\\Documentacion\\\\comprobante.pdf");
        PdfWriter.getInstance(document,fos);
    }
    public void abrirDocumento(){
        document.open();
    }
    public void generar(String texto) throws DocumentException, FileNotFoundException {
        Creardocumento();
        abrirDocumento();
